...
class Salesforce_model extends CI_Model{
    ...
    public function searchSfUsertOportunities( $params ){
        ...
        $params['tipo'] = $this->validateTipo($params['tipo'], true);
        ...
        $defaultQuery = "SELECT+"
                        ...
                        ."from+Opportunity+"
                        ."WHERE+RecordType.developername=%27".$params['tipo']."%27+AND+Socio_comercial__c=%27".$params['idComercial']."%27+AND+createddate>LAST_N_YEARS:2";
        
        $url = $defaultQuery;

        $result = $this->getDataSF( $url, $params, false, 'data' );
